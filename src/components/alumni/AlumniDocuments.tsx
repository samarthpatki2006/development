                ...
                <div className="space-y-4">
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="transcript">Official Transcript ($25)</SelectItem>
                        <SelectItem value="degree_certificate">Degree Certificate ($50)</SelectItem>
                        <SelectItem value="alumni_certificate">Alumni Certificate ($15)</SelectItem>
                        <SelectItem value="recommendation_letter">Recommendation Letter ($30)</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="digital">Digital Download (Free)</SelectItem>
                        <SelectItem value="physical">Physical Mail (+$10)</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
          ...
          <div className="grid gap-4">
            {documentRequests.length > 0 ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-500">Click "New Request" to request your first document.</p>
              </div>
            )}
          </div>
        </CardContent>
