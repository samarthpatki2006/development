    ...
    <div className="h-screen flex flex-col bg-background">
      ...
      <div className={`bg-sidebar-background border-b border-border px-4 sm:px-6 py-3 sm:py-4 ${
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-foreground">Parent Portal - Messages</h1>
            <p className="text-xs sm:text-sm text-muted-foreground hidden sm:block">Connect with teachers and stay informed</p>
          </div>
          <div className="flex items-center space-x-2 sm:space-x-4">
            {linkedStudents.length > 0 && (
              <div className="flex items-center space-x-2">
                <GraduationCap className="w-4 text-muted-foreground" />
        ...
        <div className={`w-full lg:w-80 bg-sidebar-background border-r border-sidebar-border flex flex-col ${
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col overflow-hidden">
            <TabsList className="grid w-full grid-cols-2 mx-3 mt-2 bg-muted">
              ...
              <TabsTrigger value="teachers" className="data-[state=active]:bg-accent text-xs sm:text-sm">Teachers</TabsTrigger>
            </TabsList>
                    ...
                    >
                      <div className="flex items-start space-x-3">
                        <div className="relative flex-shrink-0">
                          <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-sm flex items-center justify-center text-foreground font-semibold border border-border bg-primary/10">
        ...
        {selectedChannel ? (
          ...
          <div className="flex-1 items-center justify-center bg-background hidden lg:flex">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground mb-6">Choose from your existing chats or contact a teacher</p>
