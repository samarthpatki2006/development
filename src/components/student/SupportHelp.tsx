      ...
      <Tabs defaultValue="tickets" className="space-y-4 sm:space-y-6 w-full">
        <div className="w-full">
          <TabsList className="grid w-full grid-cols-3 h-auto">
            <TabsTrigger value="tickets" className="flex items-center justify-center gap-1.5 sm:gap-2 text-xs sm:text-sm px-2 sm:px-3 py-2">
              <Ticket className="h-3.5 w-3.5 sm:h-4 sm:w-4 flex-shrink-0" />
              <span className="truncate">Support Tickets</span>
            </TabsTrigger>
            <TabsTrigger value="faqs" className="flex items-center justify-center gap-1.5 sm:gap-2 text-xs sm:text-sm px-2 sm:px-3 py-2">
              <BookOpen className="h-3.5 w-3.5 sm:h-4 sm:w-4 flex-shrink-0" />
              <span className="truncate">FAQs</span>
            </TabsTrigger>
            <TabsTrigger value="contact" className="flex items-center justify-center gap-1.5 sm:gap-2 text-xs sm:text-sm px-2 sm:px-3 py-2">
          ...
          <Card className="w-full">
            ...
            <CardContent className="p-4 sm:p-5 md:p-6">
              {supportTickets.length === 0 ? (
                ...
                <div className="space-y-3 sm:space-y-4 max-h-[600px] overflow-y-auto custom-scrollbar pr-2">
          ...
          {Object.keys(groupedFaqs).length === 0 ? (
            ...
            <div className="space-y-3 sm:space-y-4 max-h-[600px] overflow-y-auto custom-scrollbar pr-2">
              {Object.entries(groupedFaqs).map(([category, categoryFaqs]) => (
                <Card key={category} className="w-full py-4">
...
const SupportTicketDialog: React.FC<{
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="w-[95vw] max-w-lg max-h-[90vh] overflow-y-auto custom-scrollbar">
        <DialogHeader>
