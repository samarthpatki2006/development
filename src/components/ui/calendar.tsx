    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-70 hover:opacity-100 text-white hover:text-blue-200 transition-colors duration-200"
        ),
        ...
        day_selected:
          "bg-blue-500 text-white rounded-md hover:bg-blue-500 focus:bg-blue-500 focus:text-white shadow-[0_0_2px_rgba(59,130,246,0.4)]",
        day_today:
