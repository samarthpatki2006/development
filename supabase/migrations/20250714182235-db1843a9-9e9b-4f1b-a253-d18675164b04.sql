-- Update faculty to teacher step by step
-- First, add teacher to the existing enum
ALTER TYPE public.user_type_enum ADD VALUE 'teacher';

-- Update all faculty users to teacher
...
-- Update the role type enum for faculty roles
